    ...
    def build_units(self, **kwargs):
        ...
        for unit_model in unit_models:
            ...
            if unit_id in unit_items_map:
                ...
                unit_items = item_collection.get_items_by_item_id_list(unit_item_ids)
            ...
            if unit_id in unit_effects_map:
                ...
                unit_effects = effect_collection.get_effects_by_effect_id_list(unit_effect_ids)
            ...
            if unit_id in unit_dialogue_map:
                ...
                unit_dialogue = dialogue_collection.get_dialogue_by_dialogue_id_list(unit_dialogue_ids)
